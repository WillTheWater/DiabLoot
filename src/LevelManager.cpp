	...
	,mCurrentLevel{ (LEVELS::LEVEL)(LEVELS::MAX_LEVELS - 1)}
{
	...
	mLevels[LEVELS::LEVEL_ONE]->SpawnChest({ 750.f, 365.f }, false);	//fix
	mLevels[LEVELS::LEVEL_ONE]->SpawnChest({ 900.f, 525.f }, false);	//fix
	mLevels[LEVELS::LEVEL_TWO]->SpawnChest({ 530.f, 700.f }, true);
	mLevels[LEVELS::LEVEL_TWO]->SpawnChest({ 1250.f, 300.f }, false);
	mLevels[LEVELS::LEVEL_TWO]->SpawnChest({ 1050.f, 400.f }, false);	//fix
	mLevels[LEVELS::LEVEL_TWO]->SpawnChest({ 850.f, 200.f }, false);	//fix
	mLevels[LEVELS::LEVEL_THREE]->SpawnChest({ 200.f, 980.f }, true);
	mLevels[LEVELS::LEVEL_THREE]->SpawnChest({ 1170.f, 170.f }, true);
	mLevels[LEVELS::LEVEL_THREE]->SpawnChest({ 870.f, 370.f }, true);	//fix
	mLevels[LEVELS::LEVEL_THREE]->SpawnChest({ 570.f, 570.f }, true);	//fix
	mLevels[LEVELS::LEVEL_FOUR]->SpawnChest({ 1170.f, 560.f }, false);
	mLevels[LEVELS::LEVEL_FOUR]->SpawnChest({ 870.f, 860.f }, false);	//fix
	mLevels[LEVELS::LEVEL_FOUR]->SpawnChest({ 670.f, 660.f }, false);	//fix
	mLevels[LEVELS::LEVEL_FOUR]->SpawnChest({ 280.f, 260.f }, false);	//fix
	mLevels[LEVELS::LEVEL_FIVE]->SpawnChest({ 1200.f, 920.f }, false);
	mLevels[LEVELS::LEVEL_FIVE]->SpawnChest({ 1120.f, 430.f }, true);
	mLevels[LEVELS::LEVEL_FIVE]->SpawnChest({ 800.f, 830.f }, true);	//fix
	mLevels[LEVELS::LEVEL_FIVE]->SpawnChest({ 560.f, 560.f }, true);	//fix
	...
	mLevels[LEVELS::LEVEL_SIX]->SpawnChest({ 950.f, 580.f }, true);		//fix
	mLevels[LEVELS::LEVEL_SEVEN]->SpawnChest({ 1000.f, 180.f }, true);
	mLevels[LEVELS::LEVEL_SEVEN]->SpawnChest({ 600.f, 800.f }, false);
	mLevels[LEVELS::LEVEL_SEVEN]->SpawnChest({ 800.f, 900.f }, false);	//fix
	mLevels[LEVELS::LEVEL_SEVEN]->SpawnChest({ 500.f, 500.f }, false);	//fix
	mLevels[LEVELS::LEVEL_EIGHT]->SpawnChest({ 1330.f, 340.f }, false); 
	mLevels[LEVELS::LEVEL_EIGHT]->SpawnChest({ 930.f, 440.f }, false);	//fix
	mLevels[LEVELS::LEVEL_EIGHT]->SpawnChest({ 1030.f, 740.f }, false); //fix
	mLevels[LEVELS::LEVEL_EIGHT]->SpawnChest({ 530.f, 540.f }, false);	//fix
	mLevels[LEVELS::LEVEL_NINE]->SpawnChest({ 340.f, 330.f }, true);
	mLevels[LEVELS::LEVEL_NINE]->SpawnChest({ 1450.f, 320.f }, false);
	mLevels[LEVELS::LEVEL_NINE]->SpawnChest({ 950.f, 520.f }, false);	//fix
	mLevels[LEVELS::LEVEL_NINE]->SpawnChest({ 1050.f, 1020.f }, false);	//fix
	mLevels[LEVELS::LEVEL_TEN]->SpawnChest({ 1180.f, 480.f }, false);
	mLevels[LEVELS::LEVEL_TEN]->SpawnChest({ 600.f, 350.f }, true);
	mLevels[LEVELS::LEVEL_TEN]->SpawnChest({ 900.f, 550.f }, true);		//fix
	mLevels[LEVELS::LEVEL_TEN]->SpawnChest({ 750.f, 750.f }, true);		//fix
